...
ActiveRecord::Schema.define(version: 2021_07_31_162720) do
  ...
  create_table "artistes", force: :cascade do |t|
    ...
    t.text "description"
    t.text "les_dessous"
    t.string "youtube_nouveaute1"
    t.string "youtube_nouveaute2"
    t.string "youtube_nouveaute3"
    t.string "youtube_nouveaute4"
    t.string "instagram_link"
    t.string "spotify_link"
    t.string "youtube_link_for_contacts"
